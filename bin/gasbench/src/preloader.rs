...
lazy_static! {
    pub static ref WETH_ADDRESS: Address = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"
        .parse()
        .unwrap();
    pub static ref USDC_ADDRESS: Address = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"
        .parse()
        .unwrap();
    pub static ref USDT_ADDRESS: Address = "0xdAC17F958D2ee523a2206206994597C13D831ec7"
        .parse()
        .unwrap();
    pub static ref DAI_ADDRESS: Address = "0x6B175474E89094C44Da98b954EedeAC495271d0F"
        .parse()
        .unwrap();
    pub static ref WBTC_ADDRESS: Address = "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599"
        .parse()
        .unwrap();
    pub static ref THREECRV_ADDRESS: Address = "0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490"
        .parse()
        .unwrap();
    pub static ref CRV_ADDRESS: Address = "0xD533a949740bb3306d119CC777fa900bA034cd52"
        .parse()
        .unwrap();
    pub static ref LUSD_ADDRESS: Address = "0x5f98805A4E8be255a32880FDeC7F6728C6568bA0"
        .parse()
        .unwrap();
...
pub async fn preload_pools<P, T, N>(
    client: P,
    ...
    P: Provider<T, N> + DebugProviderExt<T, N> + Send + Sync + Clone + 'static,
{
    ...
    let lusd_token = Token::new_with_data(
        *LUSD_ADDRESS,
        Some("LUSD".to_string()),
        None,
        Some(18),
