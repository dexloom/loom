...
async fn load_pools<P: Provider + DebugProviderExt + Send + Sync + Clone + 'static>(
    ...
    fetch_and_add_pool_by_address(
        ...
        market.clone(),
        market_state.clone(),
        "0x801ccfae9d2c77893b545e8d0e4637c055cd26cb"
            .parse()
            .unwrap(),
        PoolClass::UniswapV3,
    )
    ...
    fetch_and_add_pool_by_address(
        ...
        market.clone(),
        market_state.clone(),
        "0xfa6e8e97ececdc36302eca534f63439b1e79487b"
            .parse()
            .unwrap(),
        PoolClass::UniswapV3,
    )
    ...
    fetch_and_add_pool_by_address(
        ...
        market.clone(),
        market_state.clone(),
        "0x177a9b475f55b6b7b25204e2562a39308bba2a54"
            .parse()
            .unwrap(),
        PoolClass::UniswapV2,
    )
    ...
    fetch_and_add_pool_by_address(
        ...
        market.clone(),
        market_state.clone(),
        "0x90e7a93e0a6514cb0c84fc7acc1cb5c0793352d2"
            .parse()
            .unwrap(),
        PoolClass::UniswapV3,
    )
...
async fn load_tokens<P: Provider + DebugProviderExt + Send + Sync + Clone + 'static>(
    ...
    let usdt_address: Address = "0xdAC17F958D2ee523a2206206994597C13D831ec7"
        .parse()
        .unwrap();
    let dai_address: Address = "0x6B175474E89094C44Da98b954EedeAC495271d0F"
        .parse()
        .unwrap();
    let wbtc_address: Address = "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599"
        .parse()
        .unwrap();
    let threecrv_address: Address = "0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490"
        .parse()
        .unwrap();
    let crv_address: Address = "0xD533a949740bb3306d119CC777fa900bA034cd52"
        .parse()
        .unwrap();
