...
impl EncoderHelper {
    ...
    pub fn encode_multicaller_transfer_tips_weth(min_balance: U256, tips: U256, owner: Address) -> Bytes {
        IMultiCaller::IMultiCallerCalls::transferTipsMinBalanceWETH(
            IMultiCaller::transferTipsMinBalanceWETHCall {
                min_balance,
                tips,
                owner,
            }
    ...
    pub fn encode_multicaller_transfer_tips(token: Address, min_balance: U256, tips: U256, owner: Address) -> Bytes {
        IMultiCaller::IMultiCallerCalls::transferTipsMinBalance(
            IMultiCaller::transferTipsMinBalanceCall {
                token,
                min_balance,
                tips,
                owner,
    ...
    pub fn encode_multicaller_uni2_get_in_amount(token_from: Address, token_to: Address, pool: Address, amount: U256, fee: U256) -> Bytes {
        let call = if fee.is_zero() || fee.to::<u32>() == 9970 {
            if token_from > token_to {
                IMultiCaller::IMultiCallerCalls::uni2GetInAmountFrom0(
                    IMultiCaller::uni2GetInAmountFrom0Call {
                        pool,
                        amount,
                    }
                )
            } else {
                IMultiCaller::IMultiCallerCalls::uni2GetInAmountFrom1(
                    IMultiCaller::uni2GetInAmountFrom1Call {
                        pool,
                        amount,
                    }
                )
            ...
            if token_from > token_to {
                IMultiCaller::IMultiCallerCalls::uni2GetInAmountFrom0Comms(
                    IMultiCaller::uni2GetInAmountFrom0CommsCall {
                        pool,
                        amount,
                        fee,
                    }
                ...
                IMultiCaller::IMultiCallerCalls::uni2GetInAmountFrom1Comms(
                    IMultiCaller::uni2GetInAmountFrom1CommsCall {
                        pool,
                        amount,
                        fee,
                    }
    ...
    pub fn encode_multicaller_uni2_get_out_amount(token_from: Address, token_to: Address, pool: Address, amount: U256, fee: U256) -> Bytes {
        let call = if fee.is_zero() || fee.to::<u32>() == 9970 {
            if token_from < token_to {
                IMultiCaller::IMultiCallerCalls::uni2GetOutAmountFrom0(
                    IMultiCaller::uni2GetOutAmountFrom0Call {
                        pool,
                        amount,
                    }
                )
            } else {
                IMultiCaller::IMultiCallerCalls::uni2GetOutAmountFrom1(
                    IMultiCaller::uni2GetOutAmountFrom1Call {
                        pool,
                        amount,
                    }
                )
            ...
            if token_from < token_to {
                IMultiCaller::IMultiCallerCalls::uni2GetOutAmountFrom0Comms(
                    IMultiCaller::uni2GetOutAmountFrom0CommsCall {
                        pool,
                        amount,
                        fee,
                    }
                ...
                IMultiCaller::IMultiCallerCalls::uni2GetOutAmountFrom1Comms(
                    IMultiCaller::uni2GetOutAmountFrom1CommsCall {
                        pool,
                        amount,
                        fee,
                    }
    ...
    pub fn encode_balancer_flashloan(token: Address, amount: U256, user_data: Bytes, recipient: Address) -> Bytes {
        let call = IVault::IVaultCalls::flashLoan(
            IVault::flashLoanCall {
                recipient: recipient,
                tokens: vec![token],
                amounts: vec![amount],
                userData: user_data,
    ...
    pub fn encode_wsteth_wrap(st_eth_amount: U256) -> Bytes {
        let call = IWStEth::IWStEthCalls::wrap(
            IWStEth::wrapCall {
    ...
    pub fn encode_wsteth_unwrap(wst_eth_amount: U256) -> Bytes {
        let call = IWStEth::IWStEthCalls::unwrap(
            IWStEth::unwrapCall {
                wstETHAmount: wst_eth_amount
            }
        );
