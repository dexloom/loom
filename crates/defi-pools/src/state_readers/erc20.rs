...
impl ERC20StateReader {
    pub fn balance_of(db: &LoomInMemoryDB, env: Env, erc20_token: Address, account: Address) -> Result<U256> {
    ...
    pub fn allowance(db: &LoomInMemoryDB, env: Env, erc20_token: Address, owner: Address, spender: Address) -> Result<U256> {
        let call_data_result =
