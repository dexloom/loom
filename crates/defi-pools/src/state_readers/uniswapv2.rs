...
impl UniswapV2StateReader {
    pub fn factory(db: &InMemoryDB, env: Env, pool: Address) -> Result<Address> {
    ...
    pub fn token0(db: &InMemoryDB, env: Env, pool: Address) -> Result<Address> {
    ...
    pub fn token1(db: &InMemoryDB, env: Env, pool: Address) -> Result<Address> {
     ...
     */
    pub fn get_reserves(db: &InMemoryDB, env: Env, pool: Address) -> Result<(U256, U256)> {
