...
mod test {
    use super::*;
    use defi_address_book::{Factory, Token};
    ...
    fn test_get_uniswapv2_address() {
        ...
        let pair_address = get_uniswap2pool_address(Token::WETH, Token::USDC, Factory::UNISWAP_V2, init_code);
    ...
    fn test_get_uniswapv3_address() {
        ...
        let pair_address = get_uniswap3pool_address(Token::WETH, Token::USDC, 3000, Factory::UNISWAP_V3, init_code);
        println!("{:?}", pair_address)
    }
}
